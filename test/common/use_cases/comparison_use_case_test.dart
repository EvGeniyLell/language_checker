...
//
//     void resetBundles() {
//       lBundle = LocalizationBundle.iosXCString(
//         path: 'test/source/FeatureA.xcstrings',
//         localizations: defaultLocalizations,
//       );
//       rBundle = LocalizationBundle.androidXml(
//         paths: [
...
//         lBundle.copyWith.localizations([]);
//         final tasksMap = {
//           'left': () => useCase(lBundle.copyWith(localizations: []), rBundle),
//           'right': () => useCase(lBundle, rBundle.copyWith(localizations: [])),
//           'both': () => useCase(
//                 lBundle.copyWith(localizations: []),
//                 rBundle.copyWith(localizations: []),
//               ),
//         };
//
...
//           'left': () {
//             return useCase(
//               lBundle.copyWith(localizations: lBundle.localizations.sublist(2)),
//               rBundle,
//             );
//           },
//           'right': () => useCase(
//                 lBundle,
//                 rBundle.copyWith(
//                   localizations: rBundle.localizations.sublist(2),
//                 ),
//               ),
//         };
//
...
//           'left - 1': () => useCase(
//                 lBundle.copyWith(
//                   localizations: lBundle.localizations.copyWith()
//                     ..[1] = lBundle.localizations[0],
//                 ),
//                 rBundle,
//               ),
//           'left - 2': () => useCase(
